...
list=[new_x(:) new_y(:)];
tic; h1=myhog_list(img1,list,4,4); toc; % compute hog at the locations in the list
...
tic; h2=myhog_list(img2,list,4,4); toc; % compute hog at the locations in the list
...
[wholeImg,NewImage,offsets]=draw_align_image(xx,prevI1,prevI2);
